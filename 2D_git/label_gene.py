...
#    2D parameter
#=========================================================================
x_dim = 2  # Dimensions: (x, y)

######################## some paramters you can choose######################## 
diff_scale = np.array([0.6,3.0])  # make sure the standard deviation of xy_diff cannot be too small, should be big like (0.5 to 1), you can test different version
...
if os.path.exists(datadir):
    ...
    x_sample = np.load(os.path.join(datadir,'flow_x.npy'))
    y_sample = np.load(os.path.join(datadir,'flow_y.npy'))
