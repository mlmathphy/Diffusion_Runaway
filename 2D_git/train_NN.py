...
x_dim=2
diff_scale = np.array([0.6,3.0])

datadir = os.path.join(f'data_2d')
# Convert to tensors
xTrain = np.load(os.path.join(datadir, 'xTrain.npy'))
yTrain = np.load(os.path.join(datadir, 'yTrain.npy'))
...
dataname2 = os.path.join(datadir, 'data_inf.pt')
...
FN_path = os.path.join(datadir, 'FN.pth')
